...
from FDCSM.view import myAdmin
from FDCSM.view import myProfessor
from FDCSM.view import myStudent
from FDCSM.view import account
...
urlpatterns = [
    ...
    path("professor_info/professor_select_delect/", myProfessor.professor_select_delect),
